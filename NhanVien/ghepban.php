    ...
    <main id="main">
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                <div class="row">
                    <div class="col-md-6">
                    <h4 class="mt-5"><b>Ghép bàn</b></h4>
                    </div>
                    <div class="col-md-6">

                        <button class="mt-5 btn btn-warning w3-right"><i class="fa fa-print text-white small"></i>
                            In</button>
