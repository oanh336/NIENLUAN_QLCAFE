        ...
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                <div class="row">
                    ...
                    <h4 class="mt-5"><b>Thêm ca làm việc</b></h4>
                ...
                if (isset($_POST['luu'])) {
                    ...
                    if ($conn->query($sql) === TRUE) {
                        echo "<script>alert('Thêm ca làm việc thành công')</script>";
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5><input type="text" name="inputMa" class="form-control" id="inputMa" placeholder="Nhập mã ca"></h5>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5> <input type="text" name="inputTen" class="form-control" id="inputTen" placeholder="Nhập tên ca"></h5>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5><input type="time" name="inputGioBD" class="form-control" id="inputGioBD"></h5>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5><input type="time" name="inputGioKT" class="form-control" id="inputGioKT"></h5>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="inputCa" id="inputNu">
                                    <option value="" selected>-- Chọn ca --</option>
                                    <?php foreach ($ca as $key => $value_ca) { ?>
                                        <option name="inputCa" id="inputCa" value="<?php echo $value_ca['CLV_MA']; ?>"><?php echo $value_ca['CLV_MA']; ?> - <?php echo $value_ca['CLV_TEN']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
