        ...
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                <div class="row">
                    ...
                    <h4 class="mt-5"><b>Cập nhật chức vụ</b></h4>
                ...
                if (isset($_GET['id'])) {
                    $id = $_GET['id'];
                    $sql_up = "SELECT * from chucvu where CV_MA='$id'";
                    $query_up = mysqli_query($conn, $sql_up);
                ...
                if (isset($_POST['inputMa'])) {
                    ...
                    $sql = "UPDATE chucvu SET CV_MA='$txt_ma', CV_TEN='$txt_name' WHERE CV_MA ='$id' ";

                    $result = mysqli_query($conn, $sql);
                    if ($result) {

                        echo "<script>window.open('chucvu.php','_self')</script>";
                    } else {
                        echo "Lỗi";
                    }
                }
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5><input readonly value="<?php echo $row_up['CV_MA']; ?>" type="text" name="inputMa" class="form-control" id="inputMa" placeholder="Nhập mã chức vụ"></h5>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5><input value="<?php echo $row_up['CV_TEN']; ?>" type="text" name="inputTen" class="form-control" id="inputTen" placeholder="Nhập tên chức vụ"></h5>
                        </div>
                    </div>
