...
<body>
    ...
    <div class="sidenav" id="mySidebar">
        ...
        <a class="active" href="danhmuc.php"><i class="fa fa-fw fa-bars-staggered w3-small"></i> &nbsp; Quản lý danh mục</a>
        ...
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                <div class="row">
                    ...
                    <h4 class="mt-5"><b>Cập nhật danh mục</b></h4>
                ...
                if (isset($_GET['id'])) {
                    $id = $_GET['id'];
                    $sql_up = "SELECT * from loainuoc where LN_MA='$id'";
                    $query_up = mysqli_query($conn, $sql_up);
                ...
                if (isset($_POST['inputMa'])) {
                    ...
                    $sql = "UPDATE loainuoc SET LN_TEN='$txt_name' WHERE LN_MA ='$id' ";

                    $result = mysqli_query($conn, $sql);
                    if ($result) {

                        echo "<script>window.open('danhmuc.php','_self')</script>";
                    } else {
                        echo "Lỗi";
                    }
                }
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5><input readonly value="<?php echo $row_up['LN_MA']; ?>" type="text" name="inputMa" class="form-control" id="inputMa" placeholder="Nhập mã chức vụ"></h5>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5><input value="<?php echo $row_up['LN_TEN']; ?>" type="text" name="inputTen" class="form-control" id="inputTen" placeholder="Nhập tên chức vụ"></h5>
                        </div>
                    </div>
