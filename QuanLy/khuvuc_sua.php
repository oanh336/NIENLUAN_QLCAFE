...
<body>
    ...
    <div class="sidenav" id="mySidebar">
        ...
        <a class="active" href="khuvuc.php"><i class="fa fa-fw fa-layer-group w3-small"></i> &nbsp; Quản lý khu vực</a>
        ...
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                <div class="row">
                    ...
                    <h4 class="mt-5"><b>Cập nhật khu vực</b></h4>
                ...
                if (isset($_GET['id'])) {
                    $id = $_GET['id'];
                    $sql_up = "SELECT * from khuvuc where KV_MA='$id'";
                    $query_up = mysqli_query($conn, $sql_up);
                ...
                if (isset($_POST['inputMa'])) {
                    ...
                    $sql = "UPDATE khuvuc SET KV_TEN='$txt_name' WHERE KV_MA ='$id' ";

                    $result = mysqli_query($conn, $sql);
                    if ($result) {
                        echo "<script>window.open('khuvuc.php','_self')</script>";
                    } else {
                        echo "Lỗi";
                    }
                }
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label for="inputMa" class="col-sm-2 col-form-label">
                            <h5><b>Mã khu vực</b></h5>
                        </label>
                        <div class="col-sm-10">
                            <h5><input readonly value="<?php echo $row_up['KV_MA']; ?>" type="text" name="inputMa" class="form-control" id="inputMa" placeholder="Nhập mã khu vực"></h5>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputTen" class="col-sm-2 col-form-label">
                            <h5><b>Tên khu vực</b></h5>
                        </label>
                        <div class="col-sm-10">
                            <h5><input value="<?php echo $row_up['KV_TEN']; ?>" type="text" name="inputTen" class="form-control" id="inputTen" placeholder="Nhập tên khu vực"></h5>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary w3-right" name="luu">Lưu</button>

                </form>
                <a href="khuvuc.php"><button class="btn btn-danger w3-right me-2" name="btnsubmit">Thoát</button></a>
            </div>
