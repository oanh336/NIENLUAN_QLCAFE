    ...
    <main id="main">
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="mt-5"><b>Quản lý ca làm việc</b></h4>
                    </div>
                    <div class="col-md-6">

                        <a href="calamviec_them.php"><button class="mt-5 btn btn-primary w3-right" style="margin-bottom:10px"><i class="fa fa-plus text-white small"></i>
                                Thêm</button></a>
                ...
                <table class="table table-bordered">
                    ...
                    <?php
                    $query = "select * from calamviec where CLV_TEN LIKE '%$noidung%'";
                    ...
                    ?>
                        <tbody id="myTable">
                            <tr>
                                <td>
                                    <h5><?php echo $row['CLV_MA']; ?></h5>
                                </td>
                                <td>
                                    <h5><?php echo $row['CLV_TEN']; ?></h5>
                                </td>
                                <td>
                                    <h5><?php echo $row['CLV_GIOBD']; ?></h5>
                                </td>
                                <td>
                                    <h5> <?php echo $row['CLV_GIOKT']; ?></h5>
                                </td>
                                <td class="w3-center" width="150px">

                                    <a href="calamviec_sua.php?id=<?php echo $row['CLV_MA']; ?>"><button class="btn btn-success me-0"><i class="fa fa-pen-to-square small"></i></button></a>
                                    <a href="calamviec_xoa.php?id=<?php echo $row['CLV_MA']; ?>"  onclick="return confirm('Bạn có thực sự muốn xóa?')"><button class="btn btn-danger"><i class="fa fa-trash small"></i></button></a>
