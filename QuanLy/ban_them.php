    ...
    <main id="main">
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                ...
                ?>
                <form action="ban_them_luu.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5> <input type="text" name="inputMa" class="form-control" id="inputMa" placeholder="Nhập mã bàn"></h5>
                        </div>
                    </div>
                    <!-- họ tên nhân viên -->
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5> <input type="text" name="inputTen" class="form-control" id="inputTen" placeholder="Nhập tên bàn"></h5>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5><input type="number" name="inputSC" class="form-control" id="inputSC" placeholder="Nhập số chổ của bàn"></h5>
                        </div>
                    </div>
                    <!-- họ tên nhân viên -->
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5><input type="text" name="inputTT" class="form-control" id="inputTT" placeholder="Nhập trang thái của bàn"></h5>
                        </div>
                    </div>
                    <!-- đơn giá -->
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="inputKV" id="inputKV">
                                ...
                                <?php foreach ($result as $key => $value) { ?>
                                    <option name="inputKV" id="inputKV" value="<?php echo $value['KV_MA']; ?>"><?php echo $value['KV_TEN']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
