        ...
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                <div class="row">
                    ...
                    <h4 class="mt-5"><b>Thêm danh mục</b></h4>
                ...
                <form action="danhmuc_them_luu.php" method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label for="inputMa" class="col-sm-2 col-form-label">
                            <h5><b>Mã loại</b></h5>
                        </label>
                        <div class="col-sm-10">
                            <h5><input type="text" name="inputMa" class="form-control" id="inputMa" placeholder="Nhập mã loại danh mục"></h5>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5> <input type="text" name="inputTen" class="form-control" id="inputTen" placeholder="Nhập tên loại danh mục"></h5>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary w3-right" name="luu">Lưu</button>

                </form>
                <a href="danhmuc.php"><button class="btn btn-danger w3-right me-2" name="btnsubmit">Thoát</button></a>
            </div>
