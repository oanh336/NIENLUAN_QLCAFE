    ...
    <main id="main">
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="mt-5"><b>Quản lý bàn</b></h4>
                    </div>
                    <div class="col-md-6">


                        <a href="ban_them.php"><button class="mt-5 btn btn-primary w3-right" style="margin-bottom:10px"><i class="fa fa-plus text-white small"></i>
                                Thêm</button></a>
                ...
                <div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php
                        $query = "select * from ban b, khuvuc k where k.KV_MA=b.KV_MA  AND b.B_TEN LIKE '%$noidung%'";
                            ...
                            <tbody id="myTable">
                                <tr>
                                    ...
                                    <td class="w3-center" width="150px">
                                        ...
                                        <a href="ban_sua.php?page=edit&id=<?php echo $row['B_MA']; ?>"><button class="btn btn-success me-0"><i class="fa fa-pen-to-square small"></i></button></a>
                                        <a href="ban_xoa.php?id=<?php echo $row['B_MA']; ?>"  onclick="return confirm('Bạn có thực sự muốn xóa?')"><button class="btn btn-danger"><i class="fa fa-trash small"></i></button></a>
