    ...
    <main id="main">
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="mt-5"><b>Quản lý hóa đơn</b></h4>
                    </div>
                    <div class="col-md-6">
                        <button class="mt-5 btn btn-primary w3-right me-2"><i class="fa fa-plus text-white small"></i>
                            Thêm</button>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <?php
                    $query = "select * from hoadon  where HD_MA LIKE '%$noidung%'";
                    ...
                    ?>
                        <tbody id="myTable">
                            <tr>
                                ...
                                <td>
                                    <h5> <?php echo $row['HD_NGAYMUA']; ?></h5>
                                </td>
                                <td class="w3-center" width="150px">

                                    <a href="hoadon_sua.php?id=<?php echo $row['HD_MA']; ?>"><button class="btn btn-success me-0"><i class="fa fa-pen-to-square small"></i></button></a>
                                    <a href="hoadon_xoa.php?id=<?php echo $row['HD__MA']; ?>"><button class="btn btn-danger"><i class="fa fa-trash small"></i></button></a>
