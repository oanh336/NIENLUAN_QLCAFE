...
<body>
    ...
    <div class="sidenav" id="mySidebar">
        ...
        <a class="active" href="luongnv.php"><i class="fa fa-fw fa-sack-dollar w3-small"></i> &nbsp; Tra cứu lương nhân viên</a>
    ...
    <main id="main">
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="mt-5"><b>Tra cứu lương nhân viên</b></h4>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input  id="myInput" name="manv" type="search" class="form-control" placeholder="Nhập mã nhân viên">
            ...
            <table class="table table-bordered table-hover">
                <thead class="table-light">
                    <tr class="small">
                        ...
                        $query = "select b.NV_MA, b.NV_HOTEN, SUM(d.ST_TIEN) AS LUONG from phancong a, nhanvien b, ngaylam c, sotien d, calamviec e
                        where a.NV_MA=b.NV_MA AND a.NL_NGAY=c.NL_NGAY AND d.NL_NGAY=c.NL_NGAY AND
                        d.CLV_MA=e.CLV_MA
                        AND b.NV_MA LIKE '%$noidung%'
                        AND year(a.NL_NGAY) LIKE '%$nam%'
                        AND month(a.NL_NGAY) LIKE '%$thang%'
                        GROUP BY b.NV_MA, b.NV_HOTEN";
                    ...
                    <tbody id="myTable">
                        <tr>
                            ...
                            <td>
                                <h5><?php echo number_format($row['LUONG'], 0, ',', '.') ?></h5>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
