...
<body>
    ...
    <div class="sidenav" id="mySidebar">
        ...
        <a class="active" href="doanhthu.php"><i class="fa fa-fw fa-chart-column w3-small"></i> &nbsp; Thống kê doanh thu</a>
    ...
    <main id="main">
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="mt-5"><b>Thống kê doanh thu</b></h4>
                    </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div id="columnchart_material" style="width: 600px; height: 400px; font-size: 12px;"></div>
                    </div>
