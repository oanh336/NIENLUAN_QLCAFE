    ...
    <main id="main">
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="mt-5"><b>Quản lý sản phẩm</b></h4>
                    </div>
                    <div class="col-md-6">

                        <a href="nuocuong_them.php"><button class="mt-5 btn btn-primary w3-right me-2" style="margin-bottom:10px"><i class="fa fa-plus text-white small"></i>
                                Thêm</button></a>
                ...
                <table class="table table-bordered  table-hover">
                    ...
                    <?php
                    $query = "select * from dongia d, ngay g, nuocuong n, loainuoc l 
                        WHERE d.NU_MA=n.NU_MA AND d.N_NGAY=g.N_NGAY AND l.LN_MA=n.LN_MA  AND n.NU_TEN LIKE '%$noidung%'";
                    ...
                    ?>
                        <tbody id="myTable">
                            <tr>
                                ...
                                <td>
                                    <h5><?php echo $row['N_NGAY']; ?></h5>
                                </td>
                                <td>
                                    <h5><?php echo $row['NU_MOTA']; ?></h5>
                                </td>
                                <td><img class="group list-group-image img-circle" src="../image/<?php echo $row['NU_HINHANH']; ?>" style="width:80px;"></td>

                                <td width="120px" class="w3-center">

                                    <a href="nuocuong_sua.php?id=<?php echo $row['NU_MA']; ?>"><button class="btn btn-success me-0"><i class="fa fa-pen-to-square small"></i></button></a>
                                    <a href="nuocuong_xoa.php?id=<?php echo $row['NU_MA']; ?>&date=<?php echo $row['N_NGAY']; ?>&price=<?php echo $row['DG_GIA']; ?>"  onclick="return confirm('Bạn có thực sự muốn xóa?')"><button class="btn btn-danger"><i class="fa fa-trash small"></i></button></a>
