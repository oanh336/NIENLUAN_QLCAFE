...
<body>
    ...
    <div class="sidenav" id="mySidebar">
        ...
        <a class="active" href="calamviec.php"><i class="fa fa-fw fa-calendar-check w3-small"></i> &nbsp; Quản lý ca làm
            việc</a>
    ...
    <main id="main">
        <div style="padding-left:16px; padding-top:20px">
            <div class="container-fluid px-4">
                <div class="row">
                    ...
                    <h4 class="mt-5"><b>Cập nhật ca làm việc</b></h4>
                ...
                if (isset($_GET['id'])) {
                    $id = $_GET['id'];
                    $sql_up = "SELECT * from calamviec where CLV_MA='$id'";
                    $query_up = mysqli_query($conn, $sql_up);
                    $row_up = mysqli_fetch_assoc($query_up);
                }
                if (isset($_POST['inputMa'])) {

                    $txt_ma = $_POST['inputMa'];
                    $txt_name = $_POST['inputTen'];
                    $txt_giobd = $_POST['inputGioBD'];
                    $txt_giokt = $_POST['inputGioKT'];

                    $sql = "UPDATE calamviec SET CLV_MA='$txt_ma', CLV_TEN='$txt_name', 
                            CLV_GIOBD='$txt_giobd', CLV_GIOKT='$txt_giokt' WHERE CLV_MA ='$id' ";
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5><input readonly value="<?php echo $row_up['CLV_MA']; ?>" type="text" name="inputMa" class="form-control" id="inputMa" placeholder="Nhập mã ca"></h5>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <h5><input value="<?php echo $row_up['CLV_TEN']; ?>" type="text" name="inputTen" class="form-control" id="inputTen" placeholder="Nhập tên ca"></h5>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputGioBD" class="col-sm-2 col-form-label">
                            <h5><b>Giờ bắt đầu</b></h5>
                        </label>
                        <div class="col-sm-10">
                            <h5><input value="<?php echo $row_up['CLV_GIOBD']; ?>" type="time" name="inputGioBD" class="form-control" id="inputGioBD"></h5>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputGioKT" class="col-sm-2 col-form-label">
                            <h5><b>Giờ kết thúc</b></h5>
                        </label>
                        <div class="col-sm-10">
                            <h5><input value="<?php echo $row_up['CLV_GIOKT']; ?>" type="time" name="inputGioKT" class="form-control" id="inputGioKT"></h5>
                        </div>
                    </div>
                    <button type="button" class="text-center btn btn-warning  w3-right" data-toggle="modal" data-target="#exampleModal">Nhập số tiền</button>

                    <button onclick="reload()" type="submit" class="btn btn-primary w3-right me-2" name="luu">Lưu</button>
        ...
        <!-- Modal -->
        <?php
        $ca = mysqli_query($conn, "select * from calamviec");
        ...
        if (isset($_POST["capnhatgia"])) {
            ...
            $sql1 = "INSERT INTO ngaylam (NL_NGAY) VALUE ('$inputNgay')";
            $result1 = mysqli_query($conn, $sql1) or die(" sql1 is failed" . mysqli_error($conn));

            $gia = "INSERT INTO sotien (CLV_MA, NL_NGAY, ST_TIEN) VALUES ('$inputCa','$inputNgay','$inputGia')";
            $result = mysqli_query($conn, $gia) or die(" sql is failed" . mysqli_error($conn));
            if ($result) {
                echo "<script>window.open('calamviec.php','_self')</script>";
            } else {
                echo "Lỗi";
            }
        }
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="exampleModalLabel">Nhập số tiền mỗi ca</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                ...
                                <label for="inputCa" class="col-sm-4 col-form-label">
                                    <h5><b>Ca</b></h5>
                                </label>
                                <div class="col-sm-8">
                                    <input readonly value="<?php echo $row_up['CLV_MA']; ?>" type="text" class="form-control" name="inputCa">
                            ...
                            <div class="form-group">
                                <!-- đơn giá -->
                                <div class="form-group row">
                                    <label for="inputGia" class="col-sm-4 col-form-label">
                                        <h5><b>Số tiền</b></h5>
                                    </label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    <label for="inputNgay" class="col-sm-4 col-form-label">
                                        <h5><b>Ngày làm</b></h5>
                                    </label>
                                    <div class="col-sm-8">
                                        <input value="<?php echo $date ?>" type="datetime-local" class="form-control" name="inputNgay">
                                    </div>
                                </div>
